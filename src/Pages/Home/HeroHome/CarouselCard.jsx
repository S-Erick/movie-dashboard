...
export function CarouselCard({
  ...
  return (
    <div
      ...
      className={`absolute left-1/2 top-1/2 w-[min(100%,900px)] max-h-full aspect-[9/16] lg:aspect-[16/9] rounded-[2px] overflow-hidden border transition-all duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] [container-type:inline-size]
